        ...
        {post.description && (
          <div className="pt-2 mb-8 border-2 border-black">
            ...
            <a
              ...
              className="inline-flex items-center gap-3 text-white font-title text-lg hover:scale-105 transition-all duration-300 group bg-neutral-700 px-6 ml-9 mb-8 rounded-lg border-3 border-white py-2.5 hover:bg-black"
            >
              <svg
