        ...
        {post.description && (
          <div className="bg-neutral-700 rounded-2xl pt-2">
            ...
            <a
              ...
              className="inline-flex items-center gap-3 py-4 text-white font-title text-lg hover:scale-105 transition-all duration-300 group bg-neutral-700 px-8 ml-1.5 mt-2.5 mb-8 rounded-lg border-3 border-white"
            >
              <svg
